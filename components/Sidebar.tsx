...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar" style={{
      ...
      {/* Logo */}
      <div className="sidebar-logo" style={{ padding: '20px 20px 16px', borderBottom: '1px solid var(--border)' }}>
      ...
      <nav className="sidebar-nav" style={{ padding: '12px 10px', flex: 1 }}>
        <div className="sidebar-nav-label" style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-muted)', padding: '4px 10px 8px', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
          Navigation
        </div>
